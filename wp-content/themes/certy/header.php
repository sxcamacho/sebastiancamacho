...
<div class="crt-wrapper">
    <header id="crt-header" class="crt-logo-<?php echo esc_attr($header_options['logo_position']);?>">
                ...
                <div class="crt-head-row">
                    <?php if($header_options['hide_logo_area'] != '1'):?>
                        <div id="crt-head-col1" class="crt-head-col text-left">
                            <a id="crt-logo" class="crt-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                    ...
                    <?php if ( has_nav_menu( 'primary' ) ) : ?>
                        <div id="crt-head-col2" class="crt-head-col text-<?php echo esc_attr($header_options['menu_position']); ?>">
                    ...
                    <?php if($sidebar || (!$sidebar && has_nav_menu( 'primary' ))):?>
                        <div id="crt-head-col3" class="crt-head-col text-right<?php if(!$sidebar && has_nav_menu( 'primary' )):?> hidden-lg hidden-md<?php endif;?>">
        ...
        <?php if ( has_nav_menu( 'vertical' ) ) :
            ...
            ?>
                    <div id="crt-nav-wrap" class="hidden-sm hidden-xs">
                        <div id="crt-nav-inner"<?php if(!empty($vertical_nav_options['enable_sticky'])):?> class="crt-sticky"<?php endif;?>>
